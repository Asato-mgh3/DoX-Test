...
import StartTestButton from "@/components/loading/StartTestButton";
...
const TakeTest = () => {
  ...
  // location関数を使用するために追加
  const [, setLocation] = useLocation();
  
  // テスト開始ハンドラー - 共通ユーティリティ関数を使用
  const handleStartTest = () => {
    if (selectedBook && selectedChapter) {
      ...
      // 問題ページのURLを共通関数で準備
      const testPagePath = getTestPath(params.subject, selectedBook, selectedChapter, setNum);
          ...
          <Card className="rounded-2xl shadow-lg overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                ...
                <StartTestButton
                  subject={params.subject as AnySubjectType}
