...
const subjectData = {
  ...
  国語: {
    ...
    icon: Languages,
    color: "#781D33",
    description: "現代文、古文、漢文などの読解力と表現力を養います。",
    recentTests: [
      { id: 1, name: "国語語彙", score: "78%", date: "1週間前" },
      { id: 2, name: "古文文法", score: "65%", date: "2週間前" },
    ],
    recommendedTests: [
      { id: 1, name: "現代文読解", difficulty: "中級" },
      { id: 2, name: "漢字検定対策", difficulty: "初級" },
    ],
    textbooks: [
      { name: "入試漢字マスター1800", progress: 90, totalChapters: 10, completedChapters: 9 },
      { name: "古文単語ターゲット350", progress: 50, totalChapters: 8, completedChapters: 4 },
    ],
  },
  数学: {
    name: "数学",
    icon: Calculator,
    color: "#142B50",
    description: "数学I・A、II・B、III、Cなどの問題解決能力を身につけます。",
    recentTests: [
      { id: 1, name: "代数の基礎", score: "92%", date: "5日前" },
      { id: 2, name: "三角関数", score: "75%", date: "2週間前" },
    ],
    recommendedTests: [
      { id: 1, name: "微分積分", difficulty: "上級" },
      { id: 2, name: "確率統計", difficulty: "中級" },
    ],
    textbooks: [
      { name: "基礎からの数学I・A", progress: 45, totalChapters: 15, completedChapters: 7 },
      { name: "チャート式数学II+B", progress: 30, totalChapters: 18, completedChapters: 5 },
    ],
  },
  理科: {
    name: "理科",
    icon: Microscope,
    color: "#57386B",
    description: "物理、化学、生物、地学の基礎知識と実験考察力を養います。",
    recentTests: [
      { id: 1, name: "化学元素記号", score: "88%", date: "3日前" },
      { id: 2, name: "物理力学", score: "72%", date: "1週間前" },
    ],
    recommendedTests: [
      { id: 1, name: "理科：周期表", difficulty: "中級" },
      { id: 2, name: "生物：細胞分裂", difficulty: "上級" },
    ],
    textbooks: [
      { name: "化学の新研究", progress: 68, totalChapters: 20, completedChapters: 14 },
      { name: "物理のエッセンス", progress: 40, totalChapters: 16, completedChapters: 6 },
    ],
  },
  社会: {
    name: "社会",
    icon: Globe,
    color: "#DE721A",
    description: "地理、歴史、公民の知識と社会的思考力を身につけます。",
    recentTests: [
      { id: 1, name: "日本史年表", score: "70%", date: "1週間前" },
      { id: 2, name: "世界地理", score: "85%", date: "2週間前" },
    ],
    recommendedTests: [
      { id: 1, name: "世界史概要", difficulty: "上級" },
      { id: 2, name: "政治経済の基礎", difficulty: "中級" },
    ],
    textbooks: [
      { name: "日本史B講義の実況中継", progress: 60, totalChapters: 18, completedChapters: 11 },
      { name: "世界史B用語集", progress: 55, totalChapters: 15, completedChapters: 8 },
    ],
  },
}
